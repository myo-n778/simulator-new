...
- Main playback, speed, and zoom controls were moved above the canvas so they remain visible.
- Range sliders were visually reduced so the bars no longer dominate the settings panel.
